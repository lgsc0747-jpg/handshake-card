...
import PersonalPageEditorPage from "./pages/PersonalPageEditorPage.tsx";
      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/personal-page" element={<ProtectedRoute><PersonalPageEditorPage /></ProtectedRoute>} />
